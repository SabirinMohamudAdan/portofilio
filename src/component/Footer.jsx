      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20">
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a href="https://github.com/SabirinMohamudAdan" className="
                 text-orange-500 hover:text-orange-600 text-2xl">
            <FaGithub/>
             </a>
              {/* LinkedIn Icon */}
          ...
          <form className="space-y-4">
            ...
            <button type="submit" className="bg-orange-500 text-white px-6 py-2 rounded hover:bg-orange-600">Send Message</button>
          </form>
        </div>
      </div>
    </footer>
